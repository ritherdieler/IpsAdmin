...
sealed class EditSubscriptionFormErrorUiState(val error:String? = null) {
    ...
    class OnEtDniErrorRegisterUiState : EditSubscriptionFormErrorUiState(DNI_ERROR)
    ...
    class OnEtRegisterSubscriptionDateErrorUiState : EditSubscriptionFormErrorUiState(SUBSCRIPTION_DATE_ERROR)
    ...
    class OnSpnTechnicianErrorRegisterUiState : EditSubscriptionFormErrorUiState(SPN_TECHNICIAN_ERROR)
    ...
    class OnDniIsInvalidErrorRegisterUiState : EditSubscriptionFormErrorUiState(DNI_IS_INVALID_ERROR)
    ...
    object CleanEtDniHasNotErrors : EditSubscriptionFormErrorUiState()
    ...
    object CleanEtSubscriptionDateNotErrors : EditSubscriptionFormErrorUiState()
    ...
    object CleanEtTechnicianNotErrors : EditSubscriptionFormErrorUiState()
