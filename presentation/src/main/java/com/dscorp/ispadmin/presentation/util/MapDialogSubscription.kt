...
import com.dscorp.ispadmin.databinding.DialogMapSubscriptionBinding
 ...
 *
 **/
class MapDialogSubscription : DialogFragment(), OnMapReadyCallback {

    private lateinit var mapView: MapView
    private lateinit var googleMap: GoogleMap
    private lateinit var selectedLatLng: LatLng

    lateinit var binding: DialogMapSubscriptionBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(layoutInflater,R.layout.dialog_map_subscription,null,true)

        mapView = binding.mapViewSubscription
    ...
    override fun onMapReady(map: GoogleMap) {
        ...
        googleMap.setOnCameraMoveListener {
            ...
            if (this@MapDialogSubscription::selectedLatLng.isInitialized) {
                binding.btnConfirmSubscription.isEnabled = true
            }
        }
